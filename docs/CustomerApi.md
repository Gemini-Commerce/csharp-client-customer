...
#### Using the CustomerAcquireUnsubscriber2WithHttpInfo variant
This returns an ApiResponse object which contains the response data, status code and headers.
...
#### Using the CustomerBulkUpdateWithHttpInfo variant
This returns an ApiResponse object which contains the response data, status code and headers.
...
#### Using the CustomerCreate2WithHttpInfo variant
This returns an ApiResponse object which contains the response data, status code and headers.
...
#### Using the CustomerCreateGroupWithHttpInfo variant
This returns an ApiResponse object which contains the response data, status code and headers.
...
#### Using the CustomerCreateSubscriber2WithHttpInfo variant
This returns an ApiResponse object which contains the response data, status code and headers.
...
#### Using the CustomerFind2WithHttpInfo variant
This returns an ApiResponse object which contains the response data, status code and headers.
...
#### Using the CustomerFindByIdWithHttpInfo variant
This returns an ApiResponse object which contains the response data, status code and headers.
...
#### Using the CustomerFindSubscriberByIdWithHttpInfo variant
This returns an ApiResponse object which contains the response data, status code and headers.
...
#### Using the CustomerGetGroupByIdWithHttpInfo variant
This returns an ApiResponse object which contains the response data, status code and headers.
...
#### Using the CustomerGrantPermissions2WithHttpInfo variant
This returns an ApiResponse object which contains the response data, status code and headers.
...
#### Using the CustomerListCustomers2WithHttpInfo variant
This returns an ApiResponse object which contains the response data, status code and headers.
...
namespace Example
{
    public class CustomerListGroupsExample
    {
        public static void Main()
        {
            Configuration config = new Configuration();
            ...
            {
                Debug.Print("Exception when calling CustomerApi.CustomerListGroups: " + e.Message);
                Debug.Print("Status Code: " + e.ErrorCode);
                Debug.Print(e.StackTrace);
            }
        }
...
#### Using the CustomerListGroupsWithHttpInfo variant
This returns an ApiResponse object which contains the response data, status code and headers.

```csharp
try
{
    ApiResponse<CustomerListGroupsResponse> response = apiInstance.CustomerListGroupsWithHttpInfo(body);
    Debug.Write("Status Code: " + response.StatusCode);
    Debug.Write("Response Headers: " + response.Headers);
    Debug.Write("Response Body: " + response.Data);
}
...
{
    Debug.Print("Exception when calling CustomerApi.CustomerListGroupsWithHttpInfo: " + e.Message);
    Debug.Print("Status Code: " + e.ErrorCode);
    Debug.Print(e.StackTrace);
}
```
...
# **CustomerListGroups2**
> CustomerListGroupsResponse CustomerListGroups2 (CustomerListGroupsRequest body)
...
namespace Example
{
    public class CustomerListGroups2Example
    {
        public static void Main()
        {
            Configuration config = new Configuration();
            ...
            {
                Debug.Print("Exception when calling CustomerApi.CustomerListGroups2: " + e.Message);
                Debug.Print("Status Code: " + e.ErrorCode);
                Debug.Print(e.StackTrace);
            }
        }
...
#### Using the CustomerListGroups2WithHttpInfo variant
This returns an ApiResponse object which contains the response data, status code and headers.

```csharp
try
{
    ApiResponse<CustomerListGroupsResponse> response = apiInstance.CustomerListGroups2WithHttpInfo(body);
    Debug.Write("Status Code: " + response.StatusCode);
    Debug.Write("Response Headers: " + response.Headers);
    Debug.Write("Response Body: " + response.Data);
}
...
{
    Debug.Print("Exception when calling CustomerApi.CustomerListGroups2WithHttpInfo: " + e.Message);
    Debug.Print("Status Code: " + e.ErrorCode);
    Debug.Print(e.StackTrace);
}
```
...
> CustomerGroupResponse CustomerRemoveCustomerFromGroup (CustomerRemoveCustomerFromGroupRequest body)
...
namespace Example
{
    public class CustomerRemoveCustomerFromGroupExample
    {
        public static void Main()
        {
            Configuration config = new Configuration();
            ...
            {
                Debug.Print("Exception when calling CustomerApi.CustomerRemoveCustomerFromGroup: " + e.Message);
                Debug.Print("Status Code: " + e.ErrorCode);
                Debug.Print(e.StackTrace);
            }
        }
...
#### Using the CustomerRemoveCustomerFromGroupWithHttpInfo variant
This returns an ApiResponse object which contains the response data, status code and headers.

```csharp
try
{
    ApiResponse<CustomerGroupResponse> response = apiInstance.CustomerRemoveCustomerFromGroupWithHttpInfo(body);
    Debug.Write("Status Code: " + response.StatusCode);
    Debug.Write("Response Headers: " + response.Headers);
    Debug.Write("Response Body: " + response.Data);
}
...
{
    Debug.Print("Exception when calling CustomerApi.CustomerRemoveCustomerFromGroupWithHttpInfo: " + e.Message);
    Debug.Print("Status Code: " + e.ErrorCode);
    Debug.Print(e.StackTrace);
}
```
...
> CustomerGroupResponse CustomerRemoveCustomerFromGroup2 (CustomerRemoveCustomerFromGroupRequest body)
...
namespace Example
{
    public class CustomerRemoveCustomerFromGroup2Example
    {
        public static void Main()
        {
            Configuration config = new Configuration();
            ...
            {
                Debug.Print("Exception when calling CustomerApi.CustomerRemoveCustomerFromGroup2: " + e.Message);
                Debug.Print("Status Code: " + e.ErrorCode);
                Debug.Print(e.StackTrace);
            }
        }
...
#### Using the CustomerRemoveCustomerFromGroup2WithHttpInfo variant
This returns an ApiResponse object which contains the response data, status code and headers.

```csharp
try
{
    ApiResponse<CustomerGroupResponse> response = apiInstance.CustomerRemoveCustomerFromGroup2WithHttpInfo(body);
    Debug.Write("Status Code: " + response.StatusCode);
    Debug.Write("Response Headers: " + response.Headers);
    Debug.Write("Response Body: " + response.Data);
}
...
{
    Debug.Print("Exception when calling CustomerApi.CustomerRemoveCustomerFromGroup2WithHttpInfo: " + e.Message);
    Debug.Print("Status Code: " + e.ErrorCode);
    Debug.Print(e.StackTrace);
}
```
...
> CustomerCustomerResponse CustomerRemoveDefaultAddress (CustomerRemoveDefaultAddressRequest body)
...
namespace Example
{
    public class CustomerRemoveDefaultAddressExample
    {
        public static void Main()
        {
            Configuration config = new Configuration();
            ...
            {
                Debug.Print("Exception when calling CustomerApi.CustomerRemoveDefaultAddress: " + e.Message);
                Debug.Print("Status Code: " + e.ErrorCode);
                Debug.Print(e.StackTrace);
            }
        }
...
#### Using the CustomerRemoveDefaultAddressWithHttpInfo variant
This returns an ApiResponse object which contains the response data, status code and headers.

```csharp
try
{
    ApiResponse<CustomerCustomerResponse> response = apiInstance.CustomerRemoveDefaultAddressWithHttpInfo(body);
    Debug.Write("Status Code: " + response.StatusCode);
    Debug.Write("Response Headers: " + response.Headers);
    Debug.Write("Response Body: " + response.Data);
}
...
{
    Debug.Print("Exception when calling CustomerApi.CustomerRemoveDefaultAddressWithHttpInfo: " + e.Message);
    Debug.Print("Status Code: " + e.ErrorCode);
    Debug.Print(e.StackTrace);
}
```
...
> CustomerCustomerResponse CustomerRemoveDefaultAddress2 (CustomerRemoveDefaultAddressRequest body)
...
namespace Example
{
    public class CustomerRemoveDefaultAddress2Example
    {
        public static void Main()
        {
            Configuration config = new Configuration();
            ...
            {
                Debug.Print("Exception when calling CustomerApi.CustomerRemoveDefaultAddress2: " + e.Message);
                Debug.Print("Status Code: " + e.ErrorCode);
                Debug.Print(e.StackTrace);
            }
        }
...
#### Using the CustomerRemoveDefaultAddress2WithHttpInfo variant
This returns an ApiResponse object which contains the response data, status code and headers.

```csharp
try
{
    ApiResponse<CustomerCustomerResponse> response = apiInstance.CustomerRemoveDefaultAddress2WithHttpInfo(body);
    Debug.Write("Status Code: " + response.StatusCode);
    Debug.Write("Response Headers: " + response.Headers);
    Debug.Write("Response Body: " + response.Data);
}
...
{
    Debug.Print("Exception when calling CustomerApi.CustomerRemoveDefaultAddress2WithHttpInfo: " + e.Message);
    Debug.Print("Status Code: " + e.ErrorCode);
    Debug.Print(e.StackTrace);
}
```
...
> Object CustomerRevokePermissions (CustomerRevokePermissionsRequest body)
...
namespace Example
{
    public class CustomerRevokePermissionsExample
    {
        public static void Main()
        {
            Configuration config = new Configuration();
            ...
            {
                Debug.Print("Exception when calling CustomerApi.CustomerRevokePermissions: " + e.Message);
                Debug.Print("Status Code: " + e.ErrorCode);
                Debug.Print(e.StackTrace);
            }
        }
...
#### Using the CustomerRevokePermissionsWithHttpInfo variant
This returns an ApiResponse object which contains the response data, status code and headers.

```csharp
try
{
    ApiResponse<Object> response = apiInstance.CustomerRevokePermissionsWithHttpInfo(body);
    Debug.Write("Status Code: " + response.StatusCode);
    Debug.Write("Response Headers: " + response.Headers);
    Debug.Write("Response Body: " + response.Data);
}
...
{
    Debug.Print("Exception when calling CustomerApi.CustomerRevokePermissionsWithHttpInfo: " + e.Message);
    Debug.Print("Status Code: " + e.ErrorCode);
    Debug.Print(e.StackTrace);
}
```
...
> Object CustomerRevokePermissions2 (CustomerRevokePermissionsRequest body)
...
namespace Example
{
    public class CustomerRevokePermissions2Example
    {
        public static void Main()
        {
            Configuration config = new Configuration();
            ...
            {
                Debug.Print("Exception when calling CustomerApi.CustomerRevokePermissions2: " + e.Message);
                Debug.Print("Status Code: " + e.ErrorCode);
                Debug.Print(e.StackTrace);
            }
        }
...
#### Using the CustomerRevokePermissions2WithHttpInfo variant
This returns an ApiResponse object which contains the response data, status code and headers.

```csharp
try
{
    ApiResponse<Object> response = apiInstance.CustomerRevokePermissions2WithHttpInfo(body);
    Debug.Write("Status Code: " + response.StatusCode);
    Debug.Write("Response Headers: " + response.Headers);
    Debug.Write("Response Body: " + response.Data);
}
...
{
    Debug.Print("Exception when calling CustomerApi.CustomerRevokePermissions2WithHttpInfo: " + e.Message);
    Debug.Print("Status Code: " + e.ErrorCode);
    Debug.Print(e.StackTrace);
}
```
...
# **CustomerSearch**
> CustomerSearchResponse CustomerSearch (CustomerSearchRequest body)
...
namespace Example
{
    public class CustomerSearchExample
    {
        public static void Main()
        {
            ...
            {
                Debug.Print("Exception when calling CustomerApi.CustomerSearch: " + e.Message);
                Debug.Print("Status Code: " + e.ErrorCode);
                Debug.Print(e.StackTrace);
            }
        }
...
#### Using the CustomerSearchWithHttpInfo variant
This returns an ApiResponse object which contains the response data, status code and headers.

```csharp
try
{
    ApiResponse<CustomerSearchResponse> response = apiInstance.CustomerSearchWithHttpInfo(body);
    Debug.Write("Status Code: " + response.StatusCode);
    Debug.Write("Response Headers: " + response.Headers);
    Debug.Write("Response Body: " + response.Data);
}
...
{
    Debug.Print("Exception when calling CustomerApi.CustomerSearchWithHttpInfo: " + e.Message);
    Debug.Print("Status Code: " + e.ErrorCode);
    Debug.Print(e.StackTrace);
}
```
...
# **CustomerSearch2**
> CustomerSearchResponse CustomerSearch2 (CustomerSearchRequest body)
...
namespace Example
{
    public class CustomerSearch2Example
    {
        public static void Main()
        {
            Configuration config = new Configuration();
            ...
            {
                Debug.Print("Exception when calling CustomerApi.CustomerSearch2: " + e.Message);
                Debug.Print("Status Code: " + e.ErrorCode);
                Debug.Print(e.StackTrace);
            }
        }
...
#### Using the CustomerSearch2WithHttpInfo variant
This returns an ApiResponse object which contains the response data, status code and headers.

```csharp
try
{
    ApiResponse<CustomerSearchResponse> response = apiInstance.CustomerSearch2WithHttpInfo(body);
    Debug.Write("Status Code: " + response.StatusCode);
    Debug.Write("Response Headers: " + response.Headers);
    Debug.Write("Response Body: " + response.Data);
}
...
{
    Debug.Print("Exception when calling CustomerApi.CustomerSearch2WithHttpInfo: " + e.Message);
    Debug.Print("Status Code: " + e.ErrorCode);
    Debug.Print(e.StackTrace);
}
```
...
> CustomerCustomerResponse CustomerSetDefaultAddress (CustomerSetDefaultAddressRequest body)
...
namespace Example
{
    public class CustomerSetDefaultAddressExample
    {
        public static void Main()
        {
            Configuration config = new Configuration();
            ...
            {
                Debug.Print("Exception when calling CustomerApi.CustomerSetDefaultAddress: " + e.Message);
                Debug.Print("Status Code: " + e.ErrorCode);
                Debug.Print(e.StackTrace);
            }
        }
...
#### Using the CustomerSetDefaultAddressWithHttpInfo variant
This returns an ApiResponse object which contains the response data, status code and headers.

```csharp
try
{
    ApiResponse<CustomerCustomerResponse> response = apiInstance.CustomerSetDefaultAddressWithHttpInfo(body);
    Debug.Write("Status Code: " + response.StatusCode);
    Debug.Write("Response Headers: " + response.Headers);
    Debug.Write("Response Body: " + response.Data);
}
...
{
    Debug.Print("Exception when calling CustomerApi.CustomerSetDefaultAddressWithHttpInfo: " + e.Message);
    Debug.Print("Status Code: " + e.ErrorCode);
    Debug.Print(e.StackTrace);
}
```
...
> CustomerCustomerResponse CustomerSetDefaultAddress2 (CustomerSetDefaultAddressRequest body)
...
namespace Example
{
    public class CustomerSetDefaultAddress2Example
    {
        public static void Main()
        {
            Configuration config = new Configuration();
            ...
            {
                Debug.Print("Exception when calling CustomerApi.CustomerSetDefaultAddress2: " + e.Message);
                Debug.Print("Status Code: " + e.ErrorCode);
                Debug.Print(e.StackTrace);
            }
        }
...
#### Using the CustomerSetDefaultAddress2WithHttpInfo variant
This returns an ApiResponse object which contains the response data, status code and headers.

```csharp
try
{
    ApiResponse<CustomerCustomerResponse> response = apiInstance.CustomerSetDefaultAddress2WithHttpInfo(body);
    Debug.Write("Status Code: " + response.StatusCode);
    Debug.Write("Response Headers: " + response.Headers);
    Debug.Write("Response Body: " + response.Data);
}
...
{
    Debug.Print("Exception when calling CustomerApi.CustomerSetDefaultAddress2WithHttpInfo: " + e.Message);
    Debug.Print("Status Code: " + e.ErrorCode);
    Debug.Print(e.StackTrace);
}
```
...
> Object CustomerSetPermissions (CustomerSetPermissionsRequest body)
...
namespace Example
{
    public class CustomerSetPermissionsExample
    {
        public static void Main()
        {
            Configuration config = new Configuration();
            ...
            {
                Debug.Print("Exception when calling CustomerApi.CustomerSetPermissions: " + e.Message);
                Debug.Print("Status Code: " + e.ErrorCode);
                Debug.Print(e.StackTrace);
            }
        }
...
#### Using the CustomerSetPermissionsWithHttpInfo variant
This returns an ApiResponse object which contains the response data, status code and headers.

```csharp
try
{
    ApiResponse<Object> response = apiInstance.CustomerSetPermissionsWithHttpInfo(body);
    Debug.Write("Status Code: " + response.StatusCode);
    Debug.Write("Response Headers: " + response.Headers);
    Debug.Write("Response Body: " + response.Data);
}
...
{
    Debug.Print("Exception when calling CustomerApi.CustomerSetPermissionsWithHttpInfo: " + e.Message);
    Debug.Print("Status Code: " + e.ErrorCode);
    Debug.Print(e.StackTrace);
}
```
...
> Object CustomerSetPermissions2 (CustomerSetPermissionsRequest body)
...
namespace Example
{
    public class CustomerSetPermissions2Example
    {
        public static void Main()
        {
            Configuration config = new Configuration();
            ...
            {
                Debug.Print("Exception when calling CustomerApi.CustomerSetPermissions2: " + e.Message);
                Debug.Print("Status Code: " + e.ErrorCode);
                Debug.Print(e.StackTrace);
            }
        }
...
#### Using the CustomerSetPermissions2WithHttpInfo variant
This returns an ApiResponse object which contains the response data, status code and headers.

```csharp
try
{
    ApiResponse<Object> response = apiInstance.CustomerSetPermissions2WithHttpInfo(body);
    Debug.Write("Status Code: " + response.StatusCode);
    Debug.Write("Response Headers: " + response.Headers);
    Debug.Write("Response Body: " + response.Data);
}
...
{
    Debug.Print("Exception when calling CustomerApi.CustomerSetPermissions2WithHttpInfo: " + e.Message);
    Debug.Print("Status Code: " + e.ErrorCode);
    Debug.Print(e.StackTrace);
}
```
...
> Object CustomerUnassignAgent (CustomerUnassignAgentRequest body)
...
namespace Example
{
    public class CustomerUnassignAgentExample
    {
        public static void Main()
        {
            Configuration config = new Configuration();
            ...
            {
                Debug.Print("Exception when calling CustomerApi.CustomerUnassignAgent: " + e.Message);
                Debug.Print("Status Code: " + e.ErrorCode);
                Debug.Print(e.StackTrace);
            }
        }
...
#### Using the CustomerUnassignAgentWithHttpInfo variant
This returns an ApiResponse object which contains the response data, status code and headers.

```csharp
try
{
    ApiResponse<Object> response = apiInstance.CustomerUnassignAgentWithHttpInfo(body);
    Debug.Write("Status Code: " + response.StatusCode);
    Debug.Write("Response Headers: " + response.Headers);
    Debug.Write("Response Body: " + response.Data);
}
...
{
    Debug.Print("Exception when calling CustomerApi.CustomerUnassignAgentWithHttpInfo: " + e.Message);
    Debug.Print("Status Code: " + e.ErrorCode);
    Debug.Print(e.StackTrace);
}
```
...
# **CustomerUnsubscribe**
> CustomerUnsubscribeResponse CustomerUnsubscribe (CustomerUnsubscribeRequest body)
...
namespace Example
{
    public class CustomerUnsubscribeExample
    {
        public static void Main()
        {
            Configuration config = new Configuration();
            ...
            {
                Debug.Print("Exception when calling CustomerApi.CustomerUnsubscribe: " + e.Message);
                Debug.Print("Status Code: " + e.ErrorCode);
                Debug.Print(e.StackTrace);
            }
        }
...
#### Using the CustomerUnsubscribeWithHttpInfo variant
This returns an ApiResponse object which contains the response data, status code and headers.

```csharp
try
{
    ApiResponse<CustomerUnsubscribeResponse> response = apiInstance.CustomerUnsubscribeWithHttpInfo(body);
    Debug.Write("Status Code: " + response.StatusCode);
    Debug.Write("Response Headers: " + response.Headers);
    Debug.Write("Response Body: " + response.Data);
}
...
{
    Debug.Print("Exception when calling CustomerApi.CustomerUnsubscribeWithHttpInfo: " + e.Message);
    Debug.Print("Status Code: " + e.ErrorCode);
    Debug.Print(e.StackTrace);
}
```
...
> CustomerUnsubscribeResponse CustomerUnsubscribe2 (CustomerUnsubscribeRequest body)
...
namespace Example
{
    public class CustomerUnsubscribe2Example
    {
        public static void Main()
        {
            Configuration config = new Configuration();
            ...
            {
                Debug.Print("Exception when calling CustomerApi.CustomerUnsubscribe2: " + e.Message);
                Debug.Print("Status Code: " + e.ErrorCode);
                Debug.Print(e.StackTrace);
            }
        }
...
#### Using the CustomerUnsubscribe2WithHttpInfo variant
This returns an ApiResponse object which contains the response data, status code and headers.

```csharp
try
{
    ApiResponse<CustomerUnsubscribeResponse> response = apiInstance.CustomerUnsubscribe2WithHttpInfo(body);
    Debug.Write("Status Code: " + response.StatusCode);
    Debug.Write("Response Headers: " + response.Headers);
    Debug.Write("Response Body: " + response.Data);
}
...
{
    Debug.Print("Exception when calling CustomerApi.CustomerUnsubscribe2WithHttpInfo: " + e.Message);
    Debug.Print("Status Code: " + e.ErrorCode);
    Debug.Print(e.StackTrace);
}
```
...
# **CustomerUpdate**
> CustomerCustomerResponse CustomerUpdate (CustomerUpdateRequest body)
...
try
{
    ApiResponse<CustomerCustomerResponse> response = apiInstance.CustomerUpdateWithHttpInfo(body);
    Debug.Write("Status Code: " + response.StatusCode);
    Debug.Write("Response Headers: " + response.Headers);
    Debug.Write("Response Body: " + response.Data);
}
...
# **CustomerUpdate2**
> CustomerCustomerResponse CustomerUpdate2 (CustomerUpdateRequest body)
...
namespace Example
{
    public class CustomerUpdate2Example
    {
        public static void Main()
        {
            Configuration config = new Configuration();
            ...
            {
                Debug.Print("Exception when calling CustomerApi.CustomerUpdate2: " + e.Message);
                Debug.Print("Status Code: " + e.ErrorCode);
                Debug.Print(e.StackTrace);
            }
        }
...
#### Using the CustomerUpdate2WithHttpInfo variant
This returns an ApiResponse object which contains the response data, status code and headers.

```csharp
try
{
    ApiResponse<CustomerCustomerResponse> response = apiInstance.CustomerUpdate2WithHttpInfo(body);
    Debug.Write("Status Code: " + response.StatusCode);
    Debug.Write("Response Headers: " + response.Headers);
    Debug.Write("Response Body: " + response.Data);
}
...
{
    Debug.Print("Exception when calling CustomerApi.CustomerUpdate2WithHttpInfo: " + e.Message);
    Debug.Print("Status Code: " + e.ErrorCode);
    Debug.Print(e.StackTrace);
}
```
...
> CustomerAddressUpdateResponse CustomerUpdateAddress (CustomerAddressUpdateRequest body)
...
namespace Example
{
    public class CustomerUpdateAddressExample
    {
        public static void Main()
        {
            Configuration config = new Configuration();
            ...
            {
                Debug.Print("Exception when calling CustomerApi.CustomerUpdateAddress: " + e.Message);
                Debug.Print("Status Code: " + e.ErrorCode);
                Debug.Print(e.StackTrace);
            }
        }
...
#### Using the CustomerUpdateAddressWithHttpInfo variant
This returns an ApiResponse object which contains the response data, status code and headers.

```csharp
try
{
    ApiResponse<CustomerAddressUpdateResponse> response = apiInstance.CustomerUpdateAddressWithHttpInfo(body);
    Debug.Write("Status Code: " + response.StatusCode);
    Debug.Write("Response Headers: " + response.Headers);
    Debug.Write("Response Body: " + response.Data);
}
...
{
    Debug.Print("Exception when calling CustomerApi.CustomerUpdateAddressWithHttpInfo: " + e.Message);
    Debug.Print("Status Code: " + e.ErrorCode);
    Debug.Print(e.StackTrace);
}
```
...
> CustomerAddressUpdateResponse CustomerUpdateAddress2 (CustomerAddressUpdateRequest body)
...
namespace Example
{
    public class CustomerUpdateAddress2Example
    {
        public static void Main()
        {
            Configuration config = new Configuration();
            ...
            {
                Debug.Print("Exception when calling CustomerApi.CustomerUpdateAddress2: " + e.Message);
                Debug.Print("Status Code: " + e.ErrorCode);
                Debug.Print(e.StackTrace);
            }
        }
...
#### Using the CustomerUpdateAddress2WithHttpInfo variant
This returns an ApiResponse object which contains the response data, status code and headers.

```csharp
try
{
    ApiResponse<CustomerAddressUpdateResponse> response = apiInstance.CustomerUpdateAddress2WithHttpInfo(body);
    Debug.Write("Status Code: " + response.StatusCode);
    Debug.Write("Response Headers: " + response.Headers);
    Debug.Write("Response Body: " + response.Data);
}
...
{
    Debug.Print("Exception when calling CustomerApi.CustomerUpdateAddress2WithHttpInfo: " + e.Message);
    Debug.Print("Status Code: " + e.ErrorCode);
    Debug.Print(e.StackTrace);
}
```
...
# **CustomerUpdateGroup**
> CustomerGroupResponse CustomerUpdateGroup (CustomerUpdateGroupRequest body)
...
namespace Example
{
    public class CustomerUpdateGroupExample
    {
        public static void Main()
        {
            Configuration config = new Configuration();
            ...
            {
                Debug.Print("Exception when calling CustomerApi.CustomerUpdateGroup: " + e.Message);
                Debug.Print("Status Code: " + e.ErrorCode);
                Debug.Print(e.StackTrace);
            }
        }
...
#### Using the CustomerUpdateGroupWithHttpInfo variant
This returns an ApiResponse object which contains the response data, status code and headers.

```csharp
try
{
    ApiResponse<CustomerGroupResponse> response = apiInstance.CustomerUpdateGroupWithHttpInfo(body);
    Debug.Write("Status Code: " + response.StatusCode);
    Debug.Write("Response Headers: " + response.Headers);
    Debug.Write("Response Body: " + response.Data);
}
...
{
    Debug.Print("Exception when calling CustomerApi.CustomerUpdateGroupWithHttpInfo: " + e.Message);
    Debug.Print("Status Code: " + e.ErrorCode);
    Debug.Print(e.StackTrace);
}
```
...
> CustomerGroupResponse CustomerUpdateGroup2 (CustomerUpdateGroupRequest body)
...
namespace Example
{
    public class CustomerUpdateGroup2Example
    {
        public static void Main()
        {
            Configuration config = new Configuration();
            ...
            {
                Debug.Print("Exception when calling CustomerApi.CustomerUpdateGroup2: " + e.Message);
                Debug.Print("Status Code: " + e.ErrorCode);
                Debug.Print(e.StackTrace);
            }
        }
...
#### Using the CustomerUpdateGroup2WithHttpInfo variant
This returns an ApiResponse object which contains the response data, status code and headers.

```csharp
try
{
    ApiResponse<CustomerGroupResponse> response = apiInstance.CustomerUpdateGroup2WithHttpInfo(body);
    Debug.Write("Status Code: " + response.StatusCode);
    Debug.Write("Response Headers: " + response.Headers);
    Debug.Write("Response Body: " + response.Data);
}
...
{
    Debug.Print("Exception when calling CustomerApi.CustomerUpdateGroup2WithHttpInfo: " + e.Message);
    Debug.Print("Status Code: " + e.ErrorCode);
    Debug.Print(e.StackTrace);
}
```
...
> CustomerSubscriberResponse CustomerUpdateSubscriber (CustomerUpdateSubscriberRequest body)
...
namespace Example
{
    public class CustomerUpdateSubscriberExample
    {
        public static void Main()
        {
            Configuration config = new Configuration();
            ...
            {
                Debug.Print("Exception when calling CustomerApi.CustomerUpdateSubscriber: " + e.Message);
                Debug.Print("Status Code: " + e.ErrorCode);
                Debug.Print(e.StackTrace);
            }
        }
...
#### Using the CustomerUpdateSubscriberWithHttpInfo variant
This returns an ApiResponse object which contains the response data, status code and headers.

```csharp
try
{
    ApiResponse<CustomerSubscriberResponse> response = apiInstance.CustomerUpdateSubscriberWithHttpInfo(body);
    Debug.Write("Status Code: " + response.StatusCode);
    Debug.Write("Response Headers: " + response.Headers);
    Debug.Write("Response Body: " + response.Data);
}
...
{
    Debug.Print("Exception when calling CustomerApi.CustomerUpdateSubscriberWithHttpInfo: " + e.Message);
    Debug.Print("Status Code: " + e.ErrorCode);
    Debug.Print(e.StackTrace);
}
```
...
> CustomerSubscriberResponse CustomerUpdateSubscriber2 (CustomerUpdateSubscriberRequest body)
...
namespace Example
{
    public class CustomerUpdateSubscriber2Example
    {
        public static void Main()
        {
            Configuration config = new Configuration();
            ...
            {
                Debug.Print("Exception when calling CustomerApi.CustomerUpdateSubscriber2: " + e.Message);
                Debug.Print("Status Code: " + e.ErrorCode);
                Debug.Print(e.StackTrace);
            }
        }
...
#### Using the CustomerUpdateSubscriber2WithHttpInfo variant
This returns an ApiResponse object which contains the response data, status code and headers.

```csharp
try
{
    ApiResponse<CustomerSubscriberResponse> response = apiInstance.CustomerUpdateSubscriber2WithHttpInfo(body);
    Debug.Write("Status Code: " + response.StatusCode);
    Debug.Write("Response Headers: " + response.Headers);
    Debug.Write("Response Body: " + response.Data);
}
...
{
    Debug.Print("Exception when calling CustomerApi.CustomerUpdateSubscriber2WithHttpInfo: " + e.Message);
    Debug.Print("Status Code: " + e.ErrorCode);
    Debug.Print(e.StackTrace);
}
```
