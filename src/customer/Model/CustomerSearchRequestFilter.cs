...
namespace customer.Model
{
    ...
    /// </summary>
    [DataContract(Name = "customerSearchRequestFilter")]
    public partial class CustomerSearchRequestFilter : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CustomerSearchRequestFilter" /> class.
        /// </summary>
        /// <param name="newsletter">newsletter.</param>
        /// <param name="agentGrn">agentGrn.</param>
        public CustomerSearchRequestFilter(bool newsletter = default(bool), string agentGrn = default(string))
        {
