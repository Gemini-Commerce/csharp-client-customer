...
namespace customer.Model
{
    ...
    /// </summary>
    [DataContract(Name = "customerSubscriberRequest")]
    public partial class CustomerSubscriberRequest : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CustomerSubscriberRequest" /> class.
        /// </summary>
        ...
        public CustomerSubscriberRequest(string name = default(string), string lastname = default(string), string email = default(string), string country = default(string), string gender = default(string), DateTime birthdate = default(DateTime), string nationality = default(string), CustomerEMFields em = default(CustomerEMFields), DateTime createdAt = default(DateTime), DateTime updatedAt = default(DateTime), List<CustomerNewsletterRequest> newsletters = default(List<CustomerNewsletterRequest>), string market = default(string), string preferredLocale = default(string), CustomerCreateConsentRequest consent = default(CustomerCreateConsentRequest))
        {
            this.Name = name;
