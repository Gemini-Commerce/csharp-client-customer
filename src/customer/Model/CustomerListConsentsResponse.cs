...
namespace customer.Model
{
    ...
    /// </summary>
    [DataContract(Name = "customerListConsentsResponse")]
    public partial class CustomerListConsentsResponse : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CustomerListConsentsResponse" /> class.
        /// </summary>
        /// <param name="consents">consents.</param>
        /// <param name="nextPageToken">nextPageToken.</param>
        public CustomerListConsentsResponse(List<CustomerConsent> consents = default(List<CustomerConsent>), string nextPageToken = default(string))
        {
