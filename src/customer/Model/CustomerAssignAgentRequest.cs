...
namespace customer.Model
{
    ...
    /// </summary>
    [DataContract(Name = "customerAssignAgentRequest")]
    public partial class CustomerAssignAgentRequest : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CustomerAssignAgentRequest" /> class.
        /// </summary>
        /// <param name="tenantId">tenantId.</param>
        /// <param name="agentGrn">agentGrn.</param>
        /// <param name="customerIds">customerIds.</param>
        public CustomerAssignAgentRequest(string tenantId = default(string), string agentGrn = default(string), List<string> customerIds = default(List<string>))
        {
