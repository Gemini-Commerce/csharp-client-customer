...
namespace customer.Model
{
    ...
    /// </summary>
    [DataContract(Name = "customerAddressCreateRequest")]
    public partial class CustomerAddressCreateRequest : IValidatableObject
    {
        ...
        public CustomerAddressCreateRequestKind? Kind { get; set; }
        /// <summary>
        /// Initializes a new instance of the <see cref="CustomerAddressCreateRequest" /> class.
        /// </summary>
        ...
        public CustomerAddressCreateRequest(string tenantId = default(string), string customerId = default(string), CustomerEMFields em = default(CustomerEMFields), string name = default(string), string surname = default(string), string street = default(string), string number = default(string), string zip = default(string), string city = default(string), string province = default(string), string phoneNumber = default(string), string fiscalCode = default(string), string vatNumber = default(string), CustomerAddressCreateRequestKind? kind = default(CustomerAddressCreateRequestKind?), bool varDefault = default(bool), string country = default(string), Dictionary<string, ProtobufAny> attributes = default(Dictionary<string, ProtobufAny>))
        {
